...
const ServantDetail: React.FC<ServantDetailProps> = ({ 
    servant, 
    onBack, 
    isAdmin, 
    onEdit, 
    ...
    <div className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8 animate-fade-in pb-20">
      ...
      <div className="mb-8 border-b border-gray-200 pb-4">
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end gap-6">
            <div className="flex items-center gap-4">
                <div className={`w-12 h-12 flex items-center justify-center rounded-full text-white font-bold shadow-sm ${
                    servant.className.toLowerCase() === 'saber' ? 'bg-blue-600' :
      ...
      <div className="flex flex-col lg:flex-row gap-8 mb-8 items-start">
        ...
        <div className="w-full lg:w-1/2">
            ...
            <div className="mt-6 bg-blue-50 border border-blue-100 rounded p-4 text-sm text-blue-800">
                <h3 className="font-bold mb-1">Spirit Origin Name: {servant.name}</h3>
            </div>
        </div>
