...
const App: React.FC = () => {
  ...
  // Reload data when switching main views to ensure ratings are up to date
  useEffect(() => {
    if (currentView === ViewState.HOME || currentView === ViewState.RANKING || currentView === ViewState.ADMIN) {
        loadServants();
    }
  }, [currentView]);
